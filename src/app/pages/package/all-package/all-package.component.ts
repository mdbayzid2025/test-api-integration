...
export class AllPackageComponent extends DataTableSelectionBase(adminBaseMixin(Component)) implements AfterViewInit, OnDestroy {

  // Decorator
  @ViewChild('searchForm') private searchForm: NgForm;

  // Store Data
  override allTableData: Package[] = [];
  ...
  openDetailsDialog(): void {
    this.dialog.open(TableDetailsDialogComponent, {
      data: { data: this.allTableData[0], nestedFieldName: 'name' ,image: this.allTableData[0].image},
      maxWidth: '800px',
      height: 'auto',
      maxHeight: '90vh'
    });
