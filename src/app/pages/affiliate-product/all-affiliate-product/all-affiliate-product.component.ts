...
} from "../../../shared/dialog-view/affiliate-link-dialog/affiliate-link-dialog.component";
...
export class AllAffiliateProductComponent extends adminBaseMixin(Component) implements AfterViewInit, OnDestroy {
  ...
  private getAllAffiliateProducts() {
    ...
    const filterData: FilterData = {
      pagination: pagination,
      filter: {...this.filter,...{ownerId:this.adminService.getAdminId(),ownerType: 'admin'}},
      select: this.select,
      sort: this.sortQuery
    }
