...
export class AddProjectComponent extends adminBaseMixin(Component) implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.subActivateRoute = this.activatedRoute.paramMap.subscribe((param) => {
      ...
      if (this.id) {
        this.navArray.push({name: 'Update project', url: null})
        this.getProjectById();
      } else {
        this.navArray.push({name: 'Add New project', url: null})
      }
    });
  ...
  private initDataForm() {
    this.dataForm = this.fb.group({
      ...
      replyStatus: [null],
      guestPostPrice: [null],
      linkInsertPrice: [null],
      condition: [null],
      semRushUsTraffic: [null],
      trend: [null],
      mode: [null],
      ip: [null],
      ur: [null],
      ...
      ahrefsRank: [null],
      domain: [null],
      refDomainsDoFollow: [null],
      refDomainsGovernmental: [null],
      refDomainsEducational: [null],
      refIPs: [null],
      refSubNets: [null],
      linkedDomains: [null],
      totalBacklinks: [null],
      backlinksText: [null],
      backlinksNoFollow: [null],
      backlinksRedirect: [null],
      backlinksImage: [null],
      backlinksFrame: [null],
      backlinksForm: [null],
      backlinksGovernmental: [null],
      backlinksEducational: [null],
      keywordsRankedFor: [null],
      ahrefTraffic: [null],
      trafficDate: [null],
      googleIndex: [null],
      semRushBackLinks: [null],
      semRushSubDomainBacklinks: [null],
      bingIndex: [null],
      semRushRank: [null],
