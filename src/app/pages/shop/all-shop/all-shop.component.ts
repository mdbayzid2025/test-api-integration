...
import {DATA_STATUS, DOMAIN_TYPES, SHOP_TYPES} from "../../../core/utils/app-data";
...
export class AllShopComponent extends DataTableSelectionBase(adminBaseMixin(Component)) implements AfterViewInit, OnDestroy {
